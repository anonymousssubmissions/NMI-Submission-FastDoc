# Code for the Nature Machine Intelligence submission - 'FastDoc: Domain-Specific Fast Pre-training Technique using Document-Level Taxonomy'
...
1. [<em>FastDoc(Sci.)<sub>BERT</sub></em>](https://huggingface.co/AnonymousSub/Scientific_FastDoc_PRIM_CAT_BERT_HYBRID_epochs_1)
2. [<em>FastDoc(Sci.)<sub>BERT</sub> (hier.)</em>](https://huggingface.co/AnonymousSub/Scientific_FastDoc_PRIM_CAT_HIER_BERT_HYBRID_epochs_1)
3. [<em>FastDoc(Sci.)<sub>BERT</sub> (triplet)</em>](https://huggingface.co/AnonymousSub/Scientific_FastDoc_PRIM_CAT_TRIPLET_BERT_HYBRID_epochs_1)
